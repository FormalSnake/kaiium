...
Xterm.js is a front-end component written in TypeScript that lets applications bring fully-featured terminals to their users in the browser. It's used by popular projects such as VS Code, Kaiium and Theia.
...
We also partially support _Internet Explorer 11_, meaning xterm.js should work for the most part, but we reserve the right to not provide workarounds specifically for it unless it's absolutely necessary to get the basic input/output flow working.
...
- [**Kaiium**](https://Kaiium.is): A terminal built on web technologies.
